              ...
              <div className="flex items-center gap-4 flex-wrap">
                {showStatFields && (
                  <>
                    ...
                    <div className="flex items-center gap-2"
                      data-ai-changelog-id="price-detail-stat-progressive-mode"
                      data-ai-changelog-title="新增统计累进方式选择"
                      data-ai-changelog-desc="满足产品报价且统计相关策略时展示统计累进方式选项"
                    >
                      <label className="text-sm text-gray-700">统计累进方式</label>
                      <select 
                        className="h-8 px-2 text-sm border border-gray-300 rounded focus:ring-blue-500 focus:border-blue-500"
                        value={currentConfig.statProgressiveMode || '全量统计'}
                        onChange={(e) => updatePartitionConfig(activePartitionId, { ...currentConfig, statProgressiveMode: e.target.value })}
                        data-ai-alt="统计累进方式选择"
                      >
                        <option value="全量统计">全量统计</option>
                        <option value="增量统计">增量统计</option>
                      </select>
                    </div>
                  </>
                )}
