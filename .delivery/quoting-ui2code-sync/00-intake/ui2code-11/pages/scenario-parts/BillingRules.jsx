    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 flex gap-3">
        ...
        <div className="text-sm text-blue-800 leading-relaxed">
          ...
          <p>计费场景定义了费用产生的源头依据与计算颗粒度。支持<span className="font-bold">多场景并行</span>，系统将根据“计费条件”自动匹配执行。例如：常规订单按“整单”计算运费，而特殊渠道订单按“SKU明细”计算操作费。</p>
        </div>
      </div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 relative">
        ...
        <div className="flex flex-col gap-1 mt-6">
            ...
            <>
              ...
              <div data-ai-changelog-id="billing-item-dropdown" data-ai-changelog-title="计费项目下拉搜索" data-ai-changelog-desc="将计费项目配置方式调整为下拉选择，支持模糊搜索">
                <SearchSelect
                  ...
                  options={['运费', '保价费', '出库费', '包装费', '装卸费', '上楼费']}
          ...
          {isQuotation && (
            <div className="flex items-start gap-4 mb-5" data-ai-changelog-id="scenario-stat-target" data-ai-changelog-title="场景报价统计对象" data-ai-changelog-desc="当报价方式为场景报价且计费策略为统计+合单或统计考核时，支持设置统计对象">
              <div className="flex items-center justify-end gap-1.5 mt-2 w-[100px] shrink-0">
                <span className="text-sm font-medium text-gray-700 text-right">统计对象</span>
                <i className="fa-solid fa-circle-question text-gray-400 text-xs cursor-help" title="统计的对象类型，如按单据或按金额统计"></i>
              </div>
              <div className="flex-1">
                <select
                  className="w-full h-9 px-3 border border-gray-300 rounded focus:ring-1 focus:ring-indigo-500 outline-none text-sm bg-white"
                  value={data.statTarget || '月度单量'}
                  onChange={(e) => onChange({ ...data, statTarget: e.target.value })}
                  data-ai-alt="统计对象选择"
                >
